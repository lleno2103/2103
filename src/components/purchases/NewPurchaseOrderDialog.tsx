...
import { usePurchaseOrders, PurchaseOrderItemInput } from '@/hooks/use-purchase-orders';
...
export default function NewPurchaseOrderDialog({ open, onOpenChange }: NewPurchaseOrderDialogProps) {
  ...
  const totalValue = orderItems.reduce((sum, item) => sum + item.total_value, 0);
